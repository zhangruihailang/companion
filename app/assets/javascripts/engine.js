...
$(function (undefined) {
    //私有变量
    var currentConversationTargetId,
	...
	var currentConversationTargetId = "2";

    var conver = "4";
    $("#send").click(function () {
		alert('conver===='+conver);
		alert('currentConversationTargetId===='+currentConversationTargetId);
    ...
    //初始化SDK
    RongIMClient.init("p5tvi9dst3i84"); //e0x9wycfx7flq z3v5yqkbv8v30

   
            //链接融云
            RongIMClient.connect('8hJEmqX/fXSNsd9xRDnLG/H9N5I220h217hTCLYkvMVc6nKxQlYwvcaEu4sEa5sbQnm3N+uJO7s=', {
    ...
    RongIMClient.getInstance().setOnReceiveMessageListener({
        onReceived: function (data) {
			alert('onReceived==='+data.getContent());
            if (hasSound) {
                audio.play();
            }
